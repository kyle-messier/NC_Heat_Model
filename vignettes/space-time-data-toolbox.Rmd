...
A data.frame containing lon, lat and time columns can be considered as a space-time object. But there is not metadata about the coordinate system and the time reference.
...
```{r}
vect_obj <- vect(df, geom = c("lon", "lat"), 
              crs = "EPSG:4326", 
              keepgeom = FALSE)
head(vect_obj)
